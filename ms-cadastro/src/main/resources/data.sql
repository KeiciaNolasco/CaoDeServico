...
-- Inserir Endereço e capturar o ID gerado
WITH endereco AS (
...
-- Inserir Condutor e capturar o ID gerado
    condutor AS (
INSERT INTO tabela_condutor (nome, nascimento, cpf, contato, cid, endereco_id)
VALUES ('Keicia Nolasco', '1997-07-16', 11111111111, 11111111, '6A02', (SELECT id FROM endereco))
    RETURNING id
    ),

-- Inserir Cão de Serviço e capturar o ID gerado
    cao AS (
...
-- Inserir Adestramento e capturar o ID gerado
    adestramento AS (
...
-- Inserir Documentação e capturar o ID gerado
    documentacao AS (
INSERT INTO tabela_documentacao (url_carta_treinamento, validade_carta_treinamento, url_carteira_vacina, validade_carteira_vacina, url_certificado_adestramento, validade_certificado_adestramento, url_laudo_medico, validade_laudo_medico, url_laudo_veterinario, validade_laudo_veterinario, url_prova_adestramento, qr_code)
...
-- Inserir Cadastro usando os IDs capturados
INSERT INTO tabela_cadastro (qr_code, condutor_id, cao_id, adestramento_id, documentacao_id)
VALUES (null, (SELECT id FROM condutor), (SELECT id FROM cao), (SELECT id FROM adestramento), (SELECT id FROM documentacao));